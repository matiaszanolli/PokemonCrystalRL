...
try:
    from vision.vision_processor import PokemonVisionProcessor
except ImportError:
    print("⚠️ Vision processor not available, vision features disabled")
    PokemonVisionProcessor = None
...
class AdvancedTrainingSession:
    ...
    def start_training(self):
        ...
        if self.enable_monitoring and hasattr(self.env, 'monitor') and self.env.monitor:
