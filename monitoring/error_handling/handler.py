"""
Main error handler class for centralized error management.

This module contains the ErrorHandler singleton that coordinates all error handling,
including error storage, recovery strategies, notifications, and component health tracking.
"""
...
from .types import ErrorSeverity, ErrorCategory, RecoveryStrategy, ErrorContext, ErrorEvent
