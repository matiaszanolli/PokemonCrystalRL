"""
Pokemon Crystal Memory Address Mappings

Contains validated memory addresses for Pokemon Crystal ROM data structures.
These addresses have been verified through extensive testing and analysis.
"""

from typing import Dict

# Memory address mappings for Pokemon Crystal (VALIDATED addresses from analysis)
...
# Party data structure constants
PARTY_SIZE = 6              # Maximum party size
PARTY_BYTES_PER_POKEMON = 44  # Bytes per Pokemon in party structure
PARTY_BASE_ADDRESS = 0xD163   # Base address for party data

# Data type sizes in bytes
MONEY_BYTES = 3             # Money is stored in 3 bytes (little-endian)
HP_BYTES = 2                # HP values are 2 bytes (little-endian)
MOVES_PER_POKEMON = 4       # Each Pokemon has 4 move slots
PP_PER_POKEMON = 4          # Each Pokemon has 4 PP values (one per move)